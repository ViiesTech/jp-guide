import { View, Text, SafeAreaView, TouchableOpacity, Image, TextInput, ActivityIndicator, ScrollView, ImageBackground } from 'react-native'
...
const EditProfile = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{flex:1}}>
      <FastImage source={require('../../assets/images/hi.jpeg')} style={{flex:1}}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <FastImage source={require('../../assets/images/profile.png')} style={{ alignSelf: 'center', height: 200, width: 200 }} resizeMode={'contain'} />
...
{/* 
        ...
        <View style={{ height: 60, borderRadius: 200, backgroundColor: '#FFFFFF', justifyContent: 'center', paddingHorizontal: 20, marginTop: 5 }}>
        ...
        <View style={{ height: 60, borderRadius: 200, backgroundColor: '#FFFFFF', paddingHorizontal: 20, marginTop: 5, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
